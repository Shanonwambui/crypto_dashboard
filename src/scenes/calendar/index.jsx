    ...
    return (
        <Box p={isSmallScreen ? "10px" : "20px"} sx={{backgroundColor: colors.primary[400]}} marginTop="60px">
            ...
            <Box display="flex" justifyContent="space-between" flexDirection={isSmallScreen ? 'column' : 'row'} >
                ...
                {/*CALENDAR*/}
                <Box flex="1 1 100%" ml={isSmallScreen ? '0px' : '15px'}
                 sx={{
                    backgroundColor: colors.primary[400], 
                    '.fc .fc-button': {backgroundColor: '#845ADF', borderColor: '#845ADF'},
                    '.fc .fc-button-primary:not(:disabled).fc-button-active, .fc .fc-button-primary:not(:disabled):active': {backgroundColor: colors.primary[500], color: colors.grey[400], borderColor: colors.primary[500]},
                    '.fc .fc-toolbar.fc-header-toolbar': {
                            backgroundColor: colors.primary[400] // replace 'your desired color' with the color you want
                          },
